	...
	*/
	void Crouching(){
		if(Input.GetKey(KeyCode.C)){
			transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(scaleModifier,scaleModifier/1.75f,scaleModifier), Time.deltaTime * 30);
		}
		else{
			transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(scaleModifier,scaleModifier,scaleModifier), Time.deltaTime * 30);
